...
2018-1-15
Mysteries: 
* Understand why FCR resampling doesn't work (these resamples reject more often than the original data). I found that prob of rejection even when there is only 1 covariate is too high. In my simple script, try resampling residuals and re-attaching them to fitted values. Does that work?
* Is it theoretically valid to use the weird CI for excess hits using the observed hits and the CI under the null?
